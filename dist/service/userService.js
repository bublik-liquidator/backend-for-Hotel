...
function post(request) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield userRepository_1.default.post(request);
    });
}
...
function change_password(newuser, id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield userRepository_1.default.change_password({ password, username, login }, id);
    });
}
function deleteById(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield userRepository_1.default.deleteById(userId);
    });
}
exports.default = {
    getAll,
