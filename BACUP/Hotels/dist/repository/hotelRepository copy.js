...
function post(hotel) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = "INSERT INTO hotel(name, manager_id) VALUES($1, $2) RETURNING *";
        const values = [hotel.name, hotel.manager_id];
        try {
...
function put(hotel, id) {
    return __awaiter(this, void 0, void 0, function* () {
        const query = "UPDATE hotel SET name = $1, manager_id = $2 WHERE id = $3 RETURNING *";
        const values = [hotel.name, hotel.manager_id, id];
        try {
            const res = yield dbProvider_1.default.pool.query(query, values);
